            ...
            <div className="py-8 px-4">
                ...
                <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
                    {packages.map((p) => (
                        <div
                            key={p.id}
                            className="flex flex-col align-stretch p-6 mg-auto lg:mx-0 max-w-lg text-center rounded-lg
                            ...
                            <form action={route('credit.buy', p)} method="POST" className="w-full">
                                <input
                                    ...
                                    autoComplete="off"
                                />
                                <button className="bg-blue-600 hover:bg-blue-700 focus:ring-4 font-medium rounded-lg
                                text-sm px-5 py-2.5 text-center text-white focus:ring-blue-900 w-full">
                                    Get started
                                </button>
                            </form>
                        </div>
